...
<div class="card" style="margin-top: 140px">
  ...
  <div class="card-body container">
    ...
    <h6 class="card-title text-center">@lang('CustomizedLanguage.blog_attributes.blog_form')</h6>
    ...
    <form class="forms-sample row" method="POST" action="{{ route('add_blog',['admin_id'=>Auth::user()->id]) }}" enctype="multipart/form-data">
      ...
      <div class="d-flex">
          ...
          <button class="btn btn-secondary" type="reset">@lang('CustomizedLanguage.admin_attributes.cancel')</button>
      </div>
  </form>
