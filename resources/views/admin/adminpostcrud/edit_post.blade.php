...
<div class="card" style="margin-top: 140px">
  ...
  <div class="card-body container">
    ...
    <form class="forms-sample row" method="POST"  action="{{route('admin.update_blog',['post_id'=>$post_data->id,'admin_id'=>Auth::user()->id])}}" enctype="multipart/form-data">
      @csrf
      <div class="row mb-3">
      ...
      <div class="d-flex">
          <button type="submit" class="btn btn-primary me-2">@lang('CustomizedLanguage.blog_attributes.edit')</button>
          <button class="btn btn-secondary" type="reset">@lang('CustomizedLanguage.blog_attributes.cancel')</button>
      </div>
  </form>
